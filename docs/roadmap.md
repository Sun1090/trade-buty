...
- [ ] R10.1 内容清单与中英覆盖率报告（JSON + Markdown 产物）
- [ ] R10.2 章节/课程缺口排序（按章节重要性与搜索需求）
- [ ] R10.3 中文标题与英文标题术语一致性检查
- [ ] R10.4 课程 frontmatter 描述质量评分
- [ ] R10.5 课程风险提示块覆盖率报告
- [ ] R10.6 知识库新增课程自动验收清单
- [ ] R10.7 内容变更 changelog 自动片段
- [ ] R10.8 sitemap 新增 URL 回归检查
- [ ] R10.9 搜索索引新增文档回归检查
- [ ] R10.10 章节导航与上一篇/下一篇链路回归
- [ ] R10.11 相对链接跨语言解析审计
- [ ] R10.12 图片资产与 alt 文本审计增强
- [ ] R10.13 术语表双语扩展
- [ ] R10.14 中英 slug 冲突检查
...
- [ ] R10.18 上游知识库版本变更提示
- [ ] R10.19 翻译状态历史快照
- [ ] R10.20 关键章节英文 parity 预算
- [ ] R10.21 内容搜索同义词词典
- [ ] R10.22 站内搜索无结果诊断
- [ ] R10.23 内容页 canonical/hreflang 复核
- [ ] R10.24 内容更新后的缓存失效策略
- [ ] R10.25 内容运营手册 v0.6 更新

## R11 AI 出题质量与可靠性（R11.1–R11.25）

- [ ] R11.1 AI quiz 输出 schema 严格校验
- [ ] R11.2 题干/选项/答案完整性校验
- [ ] R11.3 题目与章节相关性评分
- [ ] R11.4 重复题与近重复题检测
- [ ] R11.5 解释必须绑定引用或明确无引用
- [ ] R11.6 引用章节可访问性回归
- [ ] R11.7 错题驱动生成策略配置化
- [ ] R11.8 难度分层与本地记录
- [ ] R11.9 AI 题目质量离线 fixture 集
- [ ] R11.10 生成失败的本地题库降级
- [ ] R11.11 无 API key 禁用态文案复核
- [ ] R11.12 AI 请求取消与重复提交防护
- [ ] R11.13 AI 流式响应断线恢复
- [ ] R11.14 配额与速率限制用户反馈
- [ ] R11.15 AI 错误分级指标
- [ ] R11.16 prompt 版本与输出 schema 绑定
- [ ] R11.17 模型响应敏感内容过滤
- [ ] R11.18 投资建议/收益承诺文案门禁扩展
- [ ] R11.19 AI 反馈闭环导出
- [ ] R11.20 AI 质量抽样报告
- [ ] R11.21 AI 端点超时预算监控
- [ ] R11.22 AI 成本估算与请求计数
- [ ] R11.23 AI 页面首屏与降级性能预算
- [ ] R11.24 AI 功能可观测性文档
- [ ] R11.25 AI 质量发布检查清单
