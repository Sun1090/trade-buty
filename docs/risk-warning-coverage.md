...
> 自动生成于 2026-09-23（npm run check:risk-warning），勿手改。
...
> 构建产物侧同次核对：418 个页面逐一比对，兜底块正好出现在
> 14 个页面上（上游非 pass 共 14 篇），pass 页面零叠块。

## 课程正文（lesson）
- zh：182 篇课程 | ✅ pass：182 | 🔎 review：0 | ⚠️ gap：0
- en：182 篇课程 | ✅ pass：182 | 🔎 review：0 | ⚠️ gap：0
