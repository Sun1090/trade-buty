...
> 自动生成于 2026-09-25（`npm run check:test-clock-hygiene`），勿手改。
...
| uncontrolled-timer | src/components/replay-trainer.test.tsx | 390 | `await new Promise((r) => setTimeout(r, tickMs * 2 + 200));` |
