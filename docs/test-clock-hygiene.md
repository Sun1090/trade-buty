...
> 自动生成于 2026-09-22（`npm run check:test-clock-hygiene`），勿手改。
...
| uncontrolled-timer | src/components/replay-trainer.test.tsx | 282 | `await new Promise((r) => setTimeout(r, 700));` |
