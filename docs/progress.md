...
- 分支 / 提交：`codex/quality-coverage-batch-10`，HEAD `4ec1603`。
- 完成内容：
...
- 验证命令与结果：
  ...
  - `npm run test:coverage`：通过（255 文件 / 2,240 用例；语句 93.96%，分支 88.31%，函数 93.94%，行 96.32%）。
...
- 更新时间：2026-09-21 00:26（Asia/Shanghai）。
