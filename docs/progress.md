...
- 留给你拍板的一条：R16.97 —— 中文页三个角标是整句英文（`path.label`「Learning Path」、`chart.label`/`replay.label`「Practice」），而同词典其他 12 处角标都是中文。**判不准这是版式风格还是漏译，代理不替产品定口吻**，两种改法都写清了代价。
...
- 更新时间：2026-09-24 17:05（Asia/Shanghai）。
