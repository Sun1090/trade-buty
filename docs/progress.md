...
- 分支 / 提交：`codex/quality-coverage-batch-10`，HEAD `ab73ce1`。
- 完成内容：
...
- 验证命令与结果：
  ...
  - `npm run test:coverage`：通过（255 文件 / 2,238 用例；语句 93.94%，分支 88.28%，函数 93.94%，行 96.29%）。
...
- 更新时间：2026-09-21 00:24（Asia/Shanghai）。
