  ...
  it("渲染 Share 与 Preview 按钮", () => {
    render(
      <ReplayShareCard
        ...
        currentStreak={2}
        locale="zh"
        labels={{ share: "分享战绩", previewAlt: "预览", download: "下载", copyLink: "复制链接", copiedLink: "已复制", downloadFailed: "下载失败" }}
      />,
    );
  ...
  it("点击 Share 触发 canvas 绘制 + 下载", async () => {
    const { container } = render(
      <ReplayShareCard
        ...
        currentStreak={3}
        locale="zh"
        labels={{ share: "分享我的回放战绩", previewAlt: "预览", download: "下载", copyLink: "复制链接", copiedLink: "已复制", downloadFailed: "下载失败" }}
      />,
    );
  ...
  it("点击 Preview 后渲染预览图", async () => {
    const { container } = render(
      <ReplayShareCard
        ...
        currentStreak={1}
        locale="zh"
        labels={{ share: "分享", previewAlt: "回放卡预览", download: "下载", copyLink: "复制链接", copiedLink: "已复制", downloadFailed: "下载失败" }}
      />,
    );
