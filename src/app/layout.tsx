        ...
        <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur-md">
          <div className="mx-auto max-w-6xl px-5 h-16 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 font-bold tracking-tight">
              <CandleMark />
              <span className="text-lg min-[420px]:inline hidden">Trade&nbsp;Buty</span>
              <span className="hidden sm:inline ml-1 px-2 py-0.5 rounded-full border border-[var(--accent)]/40 text-[11px] font-medium text-accent">
                免费 · 中立
              </span>
            </Link>
            <nav className="text-sm flex items-center gap-0.5 sm:gap-1">
              ...
              >
                <span className="sm:hidden">路线</span>
