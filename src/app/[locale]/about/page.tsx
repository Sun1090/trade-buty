  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-5 py-10 space-y-8">
      ...
      <section className="prose-sm space-y-4 text-muted leading-relaxed">
        ...
        <p>{withChapterCount(en ? "Content is organized into {chapters} chapters covering everything from market basics to advanced trading strategies. Every chapter pairs its lessons with a quiz. Practising against real K-line charts lives in the Markets and Replay sections, whichever chapter you're on." : "内容分为 {chapters} 个篇章，涵盖从市场基础到高级交易策略的完整知识体系。每个篇章都配有课文与随堂测验。对着真实 K 线图练习放在「行情图」和「回放」这两栏，学哪一章都能去。")}</p>
