...
const en: Dict = {
  ...
  ai: {
    ...
    guestLimit: "Guest hourly allowance reached — log in for more",
    accountLimit: "You have used up this hour's question allowance",
    retryInTpl: "Retry in about {n} min",
    quotaRemaining: "Guests: {l} questions/hour — {n} left this hour",
    quotaLoginHint: "Hourly limit reached — log in for more",
    helpful: "Helpful",
