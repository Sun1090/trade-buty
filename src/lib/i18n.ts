...
const zh = {
  ...
  pageMeta: {
    ...
    calendarTitle: "经济日历",
    calendarDesc: "示例经济日历：一小段静态窗口里的几条关键财经发布（非农、CPI、加息决议），不是实时数据。",
    privacyTitle: "隐私政策",
...
const en: Dict = {
  ...
  pageMeta: {
    ...
    calendarDesc: "A sample economic calendar: a static window of key releases (NFP, CPI, rate decisions) — not live data.",
