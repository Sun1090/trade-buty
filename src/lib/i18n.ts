...
const zh = {
  ...
  chart: {
    ...
    retry: "重试",
    compactNote: "移动端精简视图：最近 180 根 K 线，降低流量与渲染负担。",
    fullNote: "完整视图：最近 500 根 K 线。",
    showFull: "显示完整视图",
    showCompact: "恢复精简视图",
    slowNetwork: "网络较慢：已切换为 180 根 K 线精简模式，并暂停实时推送与完整视图。",
...
const en: Dict = {
  ...
  chart: {
    ...
    retry: "Retry",
    compactNote: "Compact mobile view: latest 180 candles to reduce data and rendering load.",
    fullNote: "Full view: latest 500 candles.",
    showFull: "Show full view",
    showCompact: "Use compact view",
    slowNetwork: "Slow network: compact 180-candle mode is active; live updates and the full view are paused.",
