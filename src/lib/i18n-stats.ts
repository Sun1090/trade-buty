...
const zh = {
    ...
    recoveryBodyTpl: "连续天数已经重新计数（历史最长 {n} 天）。今天学一点，哪怕只读完一课，就会重新开始计数。",
...
const en: StatsDict = {
    ...
    recoveryBodyTpl: "Your streak has restarted (longest: {n} days). Learn something today — even one lesson read — and the count starts again.",
